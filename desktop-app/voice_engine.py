...
async def speak_text(text):
    # Desktop App TTS routing has been moved entirely to the Website (Web Speech API).
    # This function is no longer used for TTS, but we keep the stub just in case.
    pass
