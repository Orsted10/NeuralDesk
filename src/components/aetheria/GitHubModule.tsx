      ...
      >
        <div className="h-12 border-b border-white/10 bg-[#111] flex items-center justify-between px-4 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xs font-bold text-white tracking-widest uppercase">GITHUB MATRIX</h2>
              <p className="text-[9px] text-zinc-600">{githubToken ? 'Connected' : 'Not Connected'}</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="icon" onClick={fetchGithubData} className="h-8 w-8 hover:bg-white/10 rounded-lg" disabled={isRefreshing}>
        ...
        <div className="flex-1 flex flex-col min-h-0 bg-[#1e1e1e] p-6 overflow-hidden">
          <div className="flex gap-2 mb-6 bg-white/5 p-1 rounded-xl max-w-md mx-auto w-full">
